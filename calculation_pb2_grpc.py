...
class CalculatorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Calculate = channel.unary_unary(
                '/com.danielang.calculation.grpc.CalculatorService/Calculate',
...
def add_CalculatorServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.danielang.calculation.grpc.CalculatorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('com.danielang.calculation.grpc.CalculatorService', rpc_method_handlers)
